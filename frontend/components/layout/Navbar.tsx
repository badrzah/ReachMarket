  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 h-16 flex items-center justify-between px-6 bg-white border-b border-gray-200 text-gray-900">
      ...
      <div className="flex items-center gap-4">
        {/* Notifications */}
        <button
          className="relative p-2 rounded-lg transition-all hover:bg-gray-100 text-gray-600"
          title="Notifications"
        >
          <svg
            width="18"
          ...
          <span className="absolute top-1.5 right-1.5 w-2 h-2 rounded-full bg-black" />
        </button>
